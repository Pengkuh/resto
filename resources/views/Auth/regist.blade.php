      ...
      <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
          <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
            <h5 class="section-title ff-secondary text-start text-primary fw-normal">Regist Page</h5>
            <h1 class="text-white mb-4">Regist Account</h1>
            <form action="/register" method="post">
              ...
              <div class="row g-3">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input required type="text" class="form-control" id="phone" placeholder="Your phone" name="phone">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input required type="text" class="form-control" id="password" placeholder="Your password" name="address">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input required type="password" class="form-control" id="password" placeholder="Your password" name="password">
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <input required type="password" class="form-control" id="password_confirm" placeholder="Your password_confirm" name="password_confirm">
